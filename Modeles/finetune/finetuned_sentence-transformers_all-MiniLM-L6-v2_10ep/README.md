...
widget:
- source_sentence: ticket
  sentences:
  - ticket
  - responsabilité
  - fiscalité
- source_sentence: pitch
  sentences:
  - installation
  - pitch
  - facture client
- source_sentence: commande
  sentences:
  - audit
  - commande
  - expédition
- source_sentence: expéditeur
  sentences:
  - expéditeur
  - quittance
  - déclaration
- source_sentence: backend
  sentences:
  - backend
  - chat
  - permis
...
print(similarities)
# tensor([[1.0000, 1.0000, 0.2130],
#         [1.0000, 1.0000, 0.2130],
#         [0.2130, 0.2130, 1.0000]])
```
...
* Samples:
  | sentence_0                  | sentence_1                  | label          |
  |:----------------------------|:----------------------------|:---------------|
  | <code>suivi client</code>   | <code>suivi client</code>   | <code>8</code> |
  | <code>contrat</code>        | <code>contrat</code>        | <code>7</code> |
  | <code>facture client</code> | <code>facture client</code> | <code>1</code> |
