...
widget:
- source_sentence: portefeuille
  sentences:
  - portefeuille
  - réseau
  - remboursement
- source_sentence: suivi
  sentences:
  - HR
  - suivi
  - client
- source_sentence: contrat
  sentences:
  - actif
  - contrat
  - promotion
- source_sentence: relation
  sentences:
  - relation
  - document
  - chat
- source_sentence: consolidation
  sentences:
  - consolidation
  - droit
  - résolution
...
print(similarities)
# tensor([[1.0000, 1.0000, 0.2286],
#         [1.0000, 1.0000, 0.2286],
#         [0.2286, 0.2286, 1.0000]])
```
...
* Samples:
  | sentence_0                 | sentence_1                 | label          |
  |:---------------------------|:---------------------------|:---------------|
  | <code>suivi</code>         | <code>suivi</code>         | <code>5</code> |
  | <code>passif</code>        | <code>passif</code>        | <code>2</code> |
  | <code>configuration</code> | <code>configuration</code> | <code>9</code> |
