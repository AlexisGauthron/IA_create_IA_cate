...
- source_sentence: pitch
  ...
  - social media
  - entretien
- source_sentence: communication
  sentences:
  - résultat
  - communication
  - hotline
- source_sentence: framework
  sentences:
  - route
  - framework
  - service après-vente
- source_sentence: python
  sentences:
  - python
  - formation
  - planning
...
print(similarities)
# tensor([[1.0000, 1.0000, 0.3615],
#         [1.0000, 1.0000, 0.3615],
#         [0.3615, 0.3615, 1.0000]])
```
...
* Samples:
  | sentence_0                   | sentence_1                   | label          |
  |:-----------------------------|:-----------------------------|:---------------|
  | <code>mobilité</code>        | <code>mobilité</code>        | <code>7</code> |
  | <code>remise</code>          | <code>remise</code>          | <code>0</code> |
  | <code>confidentialité</code> | <code>confidentialité</code> | <code>4</code> |
