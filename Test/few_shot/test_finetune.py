...
pipeline_finetune = few_shot_finetune_module.few_shot_finetune(train_df=df_train,dev_df=df_test)


modele_finetune = pipeline_finetune.finetune(
    model_name=modele_util_finetune,
    batch_size=16,
    num_epochs=3,
    steps_evauation=50
)
modele_finetune1 = pipeline_finetune.finetune(
    model_name=modele_util_finetune,
    batch_size=16,
    num_epochs=5,
    steps_evauation=50
)
modele_finetune2 = pipeline_finetune.finetune(
    model_name=modele_util_finetune,
    batch_size=16,
    num_epochs=10,
    steps_evauation=50
)
modele_finetune3 = pipeline_finetune.finetune(
    model_name=modele_util_finetune,
    batch_size=16,
    num_epochs=20,
    steps_evauation=50
