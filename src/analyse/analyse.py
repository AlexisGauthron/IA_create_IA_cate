...
from src.analyse.metier.chatbot_llm import BusinessClarificationBot, OllamaClient
...
def analyse(
    ...
    if not only_stats:
        ...
        llm = OllamaClient(
            model=model_metier, provider=provider, format_llm="json"
        )  # adapte si tu utilises un autre modèle
