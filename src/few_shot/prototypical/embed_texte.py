...
# Classe TextEmbedder
# =============================================================================
# Renommée de 'Embed_textes' vers 'TextEmbedder'
# Raison: 'Embed_textes' utilisait un underscore dans le nom de classe
#         + nom français. Les classes doivent être en PascalCase anglais.
# =============================================================================


class TextEmbedder:
    """Classe pour générer des embeddings de texte avec sentence-transformers."""
    ...
    def load_model(self, name: str | None = None) -> SentenceTransformer:
